...
extension Opportunity {
    ...
    static var sampleOpportunities: [Opportunity] {
        [
            Opportunity(title: "QBVII",
                 author: "Leon Uris"),
            Opportunity(title: "Macbeth",
                 author: "William Shakespear",
                 dateAdded: lastWeek,
                 dateStarted: Date.now,
                 status: Status.inProgress),
            Opportunity(title: "Silence of the Grave",
            ...
            Opportunity(title: "Cardinal",
                 author: "Giles Blunt"),
            Opportunity(title: "Jackdaws",
                 author: "Ken Follett",
                 dateAdded: lastWeek,
                 dateStarted: Date.now,
            ...
            Opportunity(title: "Blackout",
                 ...
                 rating: 3,
                 status: Status.completed),
            Opportunity(title: "The Sandman",
                 author: "Lars Keplar"),
            Opportunity(title: "The Redbreast",
                 author: "Jo Nesbo",
                 dateAdded: lastWeek,
                 dateStarted: Date.now,
                 status: Status.inProgress),
            Opportunity(title: "Fatherland",
